...
export default function Home() {
  ...
  const similarPlayers=useMemo(()=>{
    ...
    return Object.entries(leagueData).flatMap(([team,players])=>players.map(player=>{
