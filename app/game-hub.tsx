...
export default function GameHub({onLegend,onPerfect,onAdmin,settings}:{onLegend:()=>void;onPerfect:()=>void;onAdmin:()=>void;settings:SiteSettings}){
  ...
  return <main className="arcade-shell motion-refresh">
    ...
    <section className="arcade-intro"><span className="motion-tag hub-motion-tag">pointer · spotlight(240)</span><div className="eyebrow">BASKETBALL GAME SERIES</div><h1>籃球，不只一種<br/><em>玩法。</em></h1><p>打造傳奇、組出完美先發，接著挑戰球員旅程。每款遊戲都為手機觸控重新設計。</p></section>
